...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.iaxjf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    try {
         ...
         * app.put('/booking/:id') // upsert ==> d update (if exists ) or insert (if doesn't exist)
